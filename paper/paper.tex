...
\title{Confounder-Aware Eco-Driving Decision Support\\ for Simulated Urban Logistics}

\author{
\begin{minipage}[t]{0.32\textwidth}
\centering
{\large Muhammad Razan Alamudi\textsuperscript{1}}\\
\textit{Dept. of Computer Sciences and Electronics}\\
\textit{Gadjah Mada University}\\
Yogyakarta, Indonesia\\
razan@madrazaldi.dev
\end{minipage}
\hfill
\begin{minipage}[t]{0.32\textwidth}
\centering
{\large Hendro Wicaksono\textsuperscript{2}}\\
\textit{School of Business, Social, and Decision Sciences}\\
\textit{Constructor University}\\
Bremen, Germany\\
h.wicaksono@constructor.university
\end{minipage}
\hfill
\begin{minipage}[t]{0.32\textwidth}
\centering
{\large Kutut Aji Prayitno\textsuperscript{2}}\\
\textit{Politeknik ATK Yogyakarta}\\
Yogyakarta, Indonesia\\
kututaji@politeknikatk.ac.id
\end{minipage}
}
...
\begin{IEEEkeywords}
Offline policy learning, causal inference, urban logistics, eco-mode, decision support, off-policy evaluation, doubly robust estimation.
\end{IEEEkeywords}
