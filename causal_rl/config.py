...
REWARD_CALIBRATION_PATH = RESULTS_DIR / "reward_weight_calibration.csv"
...
DOMINANCE_AUDIT_PATH = RESULTS_DIR / "dominance_audit.csv"
POLICY_DIFFERENCE_BOOTSTRAP_PATH = RESULTS_DIR / "policy_difference_bootstrap.csv"
ORACLE_SENSITIVITY_PATH = RESULTS_DIR / "oracle_policy_sensitivity.csv"
GROUND_TRUTH_BENCHMARK_PATH = RESULTS_DIR / "ground_truth_policy_audit.csv"
CLAIM_BOUNDARY_PATH = RESULTS_DIR / "claim_boundary_audit.csv"
ACTION_IRRELEVANT_COUNTEREXAMPLE_PATH = RESULTS_DIR / "action_irrelevant_counterexample.csv"
THEOREM_ASSUMPTION_PATH = RESULTS_DIR / "theorem_assumption_audit.csv"
HEURISTIC_DIAGNOSTICS_PATH = RESULTS_DIR / "heuristic_diagnostics.csv"
CAUSAL_DESIGN_MAPPING_PATH = RESULTS_DIR / "causal_design_mapping.csv"
RUNTIME_BENCHMARK_PATH = RESULTS_DIR / "runtime_benchmark.csv"
...
SEMANTIC_REFERENCE = {
    ...
    "distance_semantics": "distance_km is documented as distance traveled during the trip segment and is excluded from learned policy state to avoid outcome-adjacent leakage.",
    "risk_score_semantics": "risk_score is a composite safety-risk indicator with unclear decision-time availability and is excluded from learned policy state.",
    "compatibility_semantics": "compatibility_violation is a known pre-dispatch assignment flag and is excluded from the confounder-aware state.",
...
NON_CAUSAL_EXTRA_COLUMNS = ["compatibility_violation"]
...
LEARNED_POLICY_REGISTRY = {
    "non_causal_fqi": DEPLOYABLE_STATE_COLUMNS + NON_CAUSAL_EXTRA_COLUMNS,
    **ABLATION_STATE_REGISTRY,
}

SUPPORT_SWEEP_PROPENSITIES = [0.05, 0.10, 0.15]
SUPPORT_SWEEP_Q_GAPS = [0.0, 0.25, 0.5]
HEURISTIC_RISK_QUANTILE = 0.60
